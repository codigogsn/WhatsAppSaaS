...
public sealed class WebhookProcessor : IWebhookProcessor
{
        ...
        foreach (var entry in payload.Entry)
        {
            ...
            foreach (var change in entry.Changes)
            {
                ...
                foreach (var message in value.Messages)
                {
                    ...
                    // 2a-list) Normalize any list replies to plain text (interactive menu browsing disabled)
                    if (message.Type == "interactive"
        ...
        Customer? customer, CancellationToken ct)
    {
        ...
        // Message 3: Classic text prompt (interactive menu browsing disabled)
        await SendAsync(new OutgoingMessage
        {
            To = to,
    ...
    internal static bool IsGreeting(string t)
    {
        ...
        if (s.StartsWith("hola ") || s.StartsWith("hoal ") || s.StartsWith("ola ")
            || s.StartsWith("hoka ") || s.StartsWith("gola ")
